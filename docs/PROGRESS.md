...
- **Dialogue rumor previews started:** dialogue now shows a compact Memory/Rumor line when the NPC already has a salient player story, including sourced gossip before the player presses Chat.
