...
- In-world verbs: pickpocket (proximity/behind), shoplifting under clerk sightlines, street carjacks; fence/dealer as scenes.
  ...
  - Continued 2026-06-12: register robbery now uses a dedicated armed-robbery helper so the QuikStop register can never be quietly robbed off-camera; it forces warrant-grade evidence, infamy, and a Gazette entry even with no co-located NPCs.
