...
- In-world verbs: pickpocket (proximity/behind), shoplifting under clerk sightlines, street carjacks; fence/dealer as scenes.
  ...
  - Continued 2026-06-12: witness intervention has started with dialogue-driven intimidation: witnesses to active player crimes expose a pressure action, success suppresses report evidence, and failure creates the worse witness-intimidation charge linked back to the original case.
