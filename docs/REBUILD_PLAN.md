...
- In-world verbs: pickpocket (proximity/behind), shoplifting under clerk sightlines, street carjacks; fence/dealer as scenes.
  ...
  - Continued 2026-06-12: dealer spots now open the shared shop UI with black-market context instead of inheriting QuikStop-only Pocket/register robbery controls. Store and dealer payloads are covered in the scripted playtest.
