...
- Work shifts become visible montages (fast clock, workplace vignette, mid-shift dilemmas); sleeping/eating get fades and feedback.
  ...
  - Continued 2026-06-12: survival actions now share a short vignette/fade overlay for work, sleep, eating, showering, and TV time, with real-scene coverage for work/rest/eating. Full workplace montage composition remains.
